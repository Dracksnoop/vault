...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <div className={cn(
      "fixed inset-y-0 left-0 z-50 w-60 bg-[var(--sidebar-bg)] border-r border-gray-200 transform transition-transform duration-200 ease-in-out",
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex items-center justify-center h-16 px-4 border-b border-gray-200">
          ...
          <span className="ml-3 text-lg font-semibold text-gray-900">VAULT</span>
        </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "nav-item-active"
                    : "text-gray-700 hover:bg-gray-100 hover:text-[var(--magenta)]"
                )}
                onClick={onClose}
              >
